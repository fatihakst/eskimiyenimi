...
// --- LİDERLİK TABLOSU (localStorage Versiyonu) ---
...
function oyunuBitir() { isProcessing = true; skoruKaydet(skor); oyunSonuBasligiEl.textContent = "Oyun Bitti!"; oyunSonuBasligiEl.classList.remove('victory-title'); transitionToFinalScreen(); }
function oyunuKazan() { isProcessing = true; skoruKaydet(skor); oyunSonuBasligiEl.textContent = "TEBRİKLER! OYUNU BİTİRDİN!"; oyunSonuBasligiEl.classList.add('victory-title'); transitionToFinalScreen(); }
