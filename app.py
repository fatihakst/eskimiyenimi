...
# Bu blok, 'tarih.json' dosyasının tam yolunu bularak hatayı düzeltir.
...
def yeni_olay_cifti_getir():
    ...
    try:
        aday_olaylar = [o for o in kullanilmis_idler if o['id'] != olay1['id'] and o['yil'] != olay1['yil']]
...
# İlk çalıştırmada veritabanı tablolarını oluşturmak için bir komut
